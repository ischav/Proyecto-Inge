...
namespace ProyectoInge1.Controllers
{
    public class ModuloRequerimientosController : Controller
    {
        ...
        public ActionResult Index(string sortOrder, string tipo, string currentFilter, string searchString, int? page, string param)
        {
            ViewBag.pro = new SelectList(baseDatos.Proyecto, "Id", "Nombre");
            ...
            {
                requerimiento = requerimiento.Where(s => s.IdProyecto.Contains(param));
